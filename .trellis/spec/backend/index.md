...
| [Task Handoff Contract](./task-handoff.md) | Two scoped test seats, business transitions, exact confirmation and fixed files | Implemented scope |
| [Conversation References Contract](./conversation-references.md) | Explicit Skill inputs, selected child roles, file deduplication and native history | Implemented scope |
